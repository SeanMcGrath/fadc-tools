...
// The class definition in TPeakIntegrator.h has been generated automatically
...
//
// Root > T->Process("TPeakIntegrator.C")
// Root > T->Process("TPeakIntegrator.C","some options")
// Root > T->Process("TPeakIntegrator.C+")
//
